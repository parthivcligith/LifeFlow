        ...
        <div class="col-lg-5 col-md-7 login-form card ">
            <div class="card-body my-4 ">
                <div class="container ">
                    ...
                    <a href="donorlogin.php " class="mt-3 mr-1 btn btn-lg btn-primary slide-btn ">Donor<a>
                    <a href="recipientlogin.php " class="mt-3 btn btn-lg btn-primary slide-btn ">Recipient<a>
                </div>
            </div>
        </div>
